...
class ClicksRelationManager extends RelationManager
{
    ...
    public function table(Table $table): Table
    {
        return $table
            ...
            ->columns([
                Tables\Columns\TextColumn::make('recipient.address')
            ...
            ->filters([
                Tables\Filters\SelectFilter::make('recipient')
                    ...
                    ->relationship('recipient', 'address', fn ($query, $livewire) => $query
                        ->where('email_campaign_id', $livewire->getOwnerRecord()->getKey()))
                    ->searchable()
                    ->preload(),
