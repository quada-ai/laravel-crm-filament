    ...
    public static function form(Schema $schema): Schema
    {
        $details = [
            ...
            Forms\Components\Select::make('pipeline_id')
                ...
                ->options(fn () => \VentureDrake\LaravelCrm\Models\Pipeline::query()->where('model', Lead::class)->orWhereNull('model')->orderBy('name')->pluck('name', 'id'))
                ->searchable()
                ->live()
            ...
            Forms\Components\Select::make('pipeline_stage_id')
                ...
                ->options(function ($get) {
                    ...
                    $defaultPipeline = \VentureDrake\LaravelCrm\Models\Pipeline::query()->where('model', Lead::class)->first()
