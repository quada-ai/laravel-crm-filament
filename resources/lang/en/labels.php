...
return [
    ...
    'actions' => [
        ...
        'convert_quote_to_order_desc' => 'Creates a new order with the same line items and marks this quote as accepted.',
        'convert_order_to_invoice' => 'Convert order to invoice',
        'convert_order_to_invoice_desc' => 'Creates a new invoice from this order with all line items.',
        'create_delivery_from_order' => 'Create delivery from order',
        'create_delivery_from_order_desc' => 'Pre-fills the full ordered quantity for every line item.',
        'create_purchase_order_from_order' => 'Create purchase order from order',
        'create_purchase_order_from_order_desc' => 'Copies line items using each product\'s supplier price (or unit price as fallback).',
        'delivery_created' => 'Delivery :id created',
        'order_converted_to_delivery' => 'Order converted to delivery.',
        'purchase_order_created' => 'Purchase order :id created',
        'order_converted_to_purchase_order' => 'Order converted to purchase order.',
        'order_created' => 'Order :id created',
        'quote_converted_to_order' => 'Quote converted to order.',
        'invoice_created' => 'Invoice :id created',
        'order_converted_to_invoice' => 'Order converted to invoice.',
        ...
        'link' => 'Link',
        'import' => 'Import',
        'tasks_marked_complete' => ':count task(s) marked complete',
    ...
    'resources' => [
        ...
        'chat_widget' => [
            'label' => 'Chat Widget',
            'plural' => 'Chat Widgets',
            'navigation' => 'Chat Widgets',
        ],
        'contact_type' => [
            'label' => 'Contact Type',
            'plural' => 'Contact Types',
            'navigation' => 'Contact Types',
        ],
        'customer' => [
            'label' => 'Customer',
            'plural' => 'Customers',
        ...
        'feature_status' => [
            ...
            'plural' => 'Feature Statuses',
            'navigation' => 'Feature Statuses',
        ],
        'field_group' => [
            'label' => 'Field Group',
            'plural' => 'Field Groups',
            'navigation' => 'Field Groups',
        ],
        'field' => [
            'label' => 'Field',
            'plural' => 'Fields',
        ...
        'pipeline_stage_probability' => [
            'label' => 'Pipeline Stage Probability',
            'plural' => 'Pipeline Stage Probabilities',
            'navigation' => 'Stage Probabilities',
        ],
        'product' => [
            'label' => 'Product',
            'plural' => 'Products',
        ...
        'sms_campaign' => [
            ...
            'navigation' => 'SMS Campaigns',
        ],
        'sms_template' => [
            'label' => 'SMS Template',
            'plural' => 'SMS Templates',
            'navigation' => 'SMS Templates',
        ],
        'task' => [
            'label' => 'Task',
            'plural' => 'Tasks',
        ...
        'xero_contact' => [
            'label' => 'Xero Contact',
            'plural' => 'Xero Contacts',
            'navigation' => 'Xero Contacts',
        ],
        'xero_invoice' => [
            'label' => 'Xero Invoice',
            'plural' => 'Xero Invoices',
            'navigation' => 'Xero Invoices',
        ],
        'xero_item' => [
            'label' => 'Xero Item',
            'plural' => 'Xero Items',
            'navigation' => 'Xero Items',
        ],
        'xero_purchase_order' => [
            'label' => 'Xero Purchase Order',
            'plural' => 'Xero Purchase Orders',
            'navigation' => 'Xero Purchase Orders',
        ],
    ],
    ...
    // Widgets
    'widgets' => [
        'crm_stats_overview' => 'CRM Stats Overview',
        'deals_value_stat' => 'Deals Value',
        'contacts_stats_overview' => 'Contacts Overview',
        'leads_by_stage_chart' => 'Leads by Stage',
        'leads_vs_deals_chart' => 'Leads vs Deals',
        'deals_pipeline_value_chart' => 'Deals Pipeline Value',
        'deal_status_doughnut_chart' => 'Deal Status Distribution',
        'monthly_revenue_chart' => 'Monthly Revenue',
        'tasks_due_today_list' => 'Tasks Due Today',
        'recent_activity_list' => 'Recent Activity',
        'campaign_performance_chart' => 'Campaign Performance',
        'email_campaign_sends_over_time' => 'Sends Over Time',
        'email_campaign_stats' => 'Campaign Statistics',
        'email_campaign_top_urls' => 'Top Clicked Links',
        'feature_activity_stats' => 'Feature Activity',
        'feature_views_chart' => 'Views Over Time',
        'feature_votes_chart' => 'Votes Over Time',
        'monitor_response_time' => 'Response Time',
